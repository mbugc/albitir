...
export default function AuthSelectionPage() {
    ...
    try {
      ...
      if (profile) {
        ...
        navigate('/auth/signup', {
          replace: true,
          state: { googleName: user.displayName ?? '' },
        });
      }
    } catch (e: unknown) {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-white">
      {/* Hero */}
      <div className="flex flex-1 flex-col items-center justify-center bg-primary-700 px-8 text-white">
      ...
      <div className="flex flex-col gap-3 px-6 pb-10 pt-8">
        ...
        <Button variant="primary" fullWidth onClick={() => navigate('/auth/email')}>
